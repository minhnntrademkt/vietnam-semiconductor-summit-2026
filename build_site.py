...
<body class="bg-white text-slate-900 antialiased selection:bg-[#0072ce] selection:text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <a href="#" class="flex items-center gap-3.5 group">
        <div class="flex items-center">
          <!-- Marvell Brand Mark -->
          <svg class="h-7 w-auto text-[#0072ce]" viewBox="0 0 120 32" fill="currentColor">
            <path d="M0 0h12v32H0V0zm16 0h12v20l10-20h12v32H38V12L28 32H16V0zm38 0h12v32H54V0zm16 0h12l8 16 8-16h12v32H98V14l-8 16h-4l-8-16v18H70V0z"/>
          </svg>
        </div>
  ...
  <!-- =========================================================================
       8. PARTNERS & ECOSYSTEM LOGO MARQUEE (CONTINUOUS INFINITE SCROLL)
       ========================================================================= -->
  <section id="partners" class="py-16 bg-slate-50 border-b border-slate-200 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-8">
      <span class="text-xs font-bold tracking-widest text-slate-500 uppercase">GLOBAL CHIPMAKERS, STRATEGIC PARTNERS & RESEARCH UNIVERSITIES</span>
    </div>

    <!-- Partner Badges Grid -->
    <div class="max-w-6xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 items-center justify-center">
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">MARVELL</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">INTEL</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">QUALCOMM</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">RENESAS</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">AMPERE</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">VSAP-LAB</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">VNU-HCM</div>
      <div class="p-4 bg-white rounded-xl border border-slate-200 text-center font-extrabold text-slate-800 text-sm shadow-sm hover:border-[#0072ce] transition-colors">HUST</div>
    </div>
  </section>
  ...
  <!-- =========================================================================
       ...
       ========================================================================= -->
  <footer class="bg-white py-12 border-t border-slate-200 text-xs text-slate-500">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-slate-200">
        
        <div class="flex items-center gap-3">
          <svg class="h-6 w-auto text-[#0072ce]" viewBox="0 0 120 32" fill="currentColor">
            <path d="M0 0h12v32H0V0zm16 0h12v20l10-20h12v32H38V12L28 32H16V0zm38 0h12v32H54V0zm16 0h12l8 16 8-16h12v32H98V14l-8 16h-4l-8-16v18H70V0z"/>
          </svg>
          <div class="h-4 w-px bg-slate-300"></div>
          <span class="text-slate-800 font-bold">The 1st Vietnam Semiconductor Summit 2026</span>
        </div>

        <div class="flex flex-wrap items-center gap-6 font-semibold text-slate-600">
          <a href="https://www.marvell.com/company.html" target="_blank" class="hover:text-[#0072ce]">About Marvell</a>
          <a href="https://www.marvell.com/products.html" target="_blank" class="hover:text-[#0072ce]">Products & Silicon</a>
          <a href="https://www.marvell.com/company/careers.html" target="_blank" class="hover:text-[#0072ce]">Careers in Vietnam</a>
          <a href="https://www.marvell.com/privacy-statement.html" target="_blank" class="hover:text-[#0072ce]">Privacy Statement</a>
        </div>
      ...
      <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left text-[11px]">
        ...
        <p class="text-slate-500 font-mono">The 1st Vietnam Semiconductor Summit • Ho Chi Minh City</p>
      </div>
    </div>
  </footer>
